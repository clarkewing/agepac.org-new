    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-start md:justify-between">
            <div class="flex space-x-6 md:order-2">
                ...
                <a href="https://www.instagram.com/epl_agepac/" class="text-gray-400 hover:text-gray-300">
                ...
                <a href="https://twitter.com/agepac" class="text-gray-400 hover:text-gray-300">
