...
<x-public::layout>
    ...
    >
        <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Contactez-nous</h1>
    ...
    <!-- Side-by-side grid -->
    <div class="bg-white">
        <div id="contact" class="mx-auto max-w-md px-4 py-24 sm:max-w-3xl sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
            <div class="space-y-16 divide-y divide-gray-200">
                        ...
                        <div>
                            ...
                            <dl class="mt-2 text-base text-gray-600">
                                ...
                                <div class="mt-1">
                                    ...
                                    <dd>
                                        <a
                                            class="text-wedgewood-500 font-medium hover:underline"
                                            href="{{ route('public.press') }}"
                                        >
                ...
                <section class="lg:grid lg:grid-cols-3 lg:gap-8" aria-labelledby="location-heading">
                    <h2 id="location-heading" class="text-2xl font-extrabold text-gray-900 sm:text-3xl">
                        Correspondance
                    </h2>
                    <div class="mt-8 grid grid-cols-1 gap-12 sm:grid-cols-2 sm:gap-x-8 sm:gap-y-12 lg:col-span-2 lg:mt-0">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Toulouse</h3>
                            <div class="mt-2 space-y-1 text-base text-gray-600">
                                <p>AGEPAC</p>
