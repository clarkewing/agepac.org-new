...
<x-public::layout>
                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                    <div class="sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:flex-col lg:justify-center lg:text-left">
                        ...
                        <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                            L’ENAC propose 4 voies d'accès au cursus EPL. Toutes ont en commun un concours très
                            sélectif.
                        </p>

                        <div class="mt-6 sm:mx-auto sm:max-w-lg lg:hidden">
                        ...
                        <div class="mt-8 sm:mx-auto sm:max-w-lg sm:text-center lg:mx-0 lg:text-left">
                            ...
                            <a
                                class="focus:ring-vermilion-400 mt-3 flex w-full items-center justify-center rounded-md border border-transparent bg-gray-800 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-gray-900 focus:ring-2 focus:ring-offset-2 focus:outline-hidden sm:inline-flex sm:w-auto sm:shrink-0"
                                href="{{ asset('media/guide-epl-2023.pdf') }}"
                                target="_blank"
                                download
                            >
                                <x-heroicon-o-arrow-down-tray class="mr-3 -ml-1 h-5 w-5" />
                ...
                <div class="relative">
                    ...
                    <dl class="mt-10 space-y-10">
                        ...
                        <x-public::feature-section-item>
                            ...
                            <x-slot name="description">
                                ...
                                universitaire depuis au moins 2 ans et détenteurs a minima d’une licence EASA LAPL
                                (Light Aircraft Pilot License) sur avion, hélicoptère ou planeur —
                                <span class="italic"
                                    >la détention de l’ATPL(A) théorique n’étant plus obligatoire depuis 2022</span
                                >. Les candidats devront avoir déjà obtenu leur FCL.055D. Ils rejoindront les EPL/S en
                                formation théorique —
                                <span class="italic">même s’ils sont déjà détenteurs de l’ATPL(A) théorique</span>.
                            </x-slot>
                        </x-public::feature-section-item>
                    ...
                    <x-public::alert class="mt-6" type="info">
                        ...
                        >
                            ...
                            <x-heroicon-s-arrow-top-right-on-square class="ml-1 h-4 w-4" />
                        </a>
                    </x-public::alert>
                </div>
    ...
    <div class="bg-gray-50 px-8">
        <div class="relative mx-auto max-w-2xl lg:max-w-3xl">
    ...
    <div class="overflow-hidden bg-gray-50 py-12">
        <div class="relative mx-auto max-w-xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div class="relative mt-6 lg:mt-12 lg:grid lg:grid-cols-2 lg:items-center lg:gap-8">
                <div class="relative">
                    <div class="mt-10 space-y-10 text-base text-gray-500">
                        <p>
            ...
            <div class="relative mt-12 sm:mt-16 lg:mt-24">
                <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:items-center lg:gap-8">
                    ...
                    <div class="relative -mx-4 mt-10 lg:col-start-1 lg:mt-0">
                        ...
                        <div class="px-4">
                            <x-public::alert class="relative mx-auto mt-12 max-w-[490px] shadow-xl" type="warning">
