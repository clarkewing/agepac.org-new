...
<x-public::layout class="bg-white">
    ...
    >
        <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Qui sommes-nous ?</h1>
    </x-slot>
        ...
        <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
            <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:order-2 lg:px-0">
                ...
                <div class="pt-6 lg:pt-20">
                    <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Notre mission</h2>

                    <div class="mt-6 space-y-6 text-gray-500">
                        <div>
                            <p class="text-justify text-lg">
                                L’Association Générale des Élèves Pilotes de l’Aviation Civile est une association loi
                                1901 qui, depuis 1992, regroupe les Élèves Pilotes de Ligne formés à l’École Nationale
                                de l’Aviation Civile.
                            </p>
                            <p class="mt-2 text-justify text-lg">
                                Sa mission est avant tout de garantir la pérennité de la filière publique de formation
                                au pilotage, mais aussi d’assurer une bonne représentativité des actuels et anciens
                                élèves dans la communauté aéronautique.
                            </p>
                        </div>
                        <div class="text-base leading-7">
                            <p>Les buts poursuivis sont multiples :</p>
                            <ul class="list-disc pl-6 text-justify">
                                <li>
                                    Aider, par les moyens dont elle dispose, les EPL à accéder à un poste de navigant.
                                </li>
                                <li>Servir d'interlocuteur privilégié dans différentes discussions et actions.</li>
                                <li>
                                    Faire interface entre les EPL sortis de formation, et les autres acteurs du monde du
                                    transport aérien.
                                </li>
            ...
            <div class="relative mt-12 sm:mt-8 sm:py-16 lg:order-1 lg:py-0">
                <div aria-hidden="true" class="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
                    ...
                    <x-public::pattern.dots
                        class="absolute top-8 left-1/2 -ml-3 lg:top-12 lg:-right-8 lg:left-auto"
                        width="404"
                        height="392"
                    />
                </div>
    ...
    <!-- Values section -->
    <div class="relative mx-auto mt-8 max-w-md px-4 py-12 sm:max-w-3xl sm:px-6 lg:mt-16 lg:max-w-7xl lg:px-8">
        <x-public::pattern.dots
            class="absolute top-0 left-full hidden -translate-x-1/2 -translate-y-3/4 transform lg:right-full lg:left-auto lg:block lg:translate-x-2/3 lg:translate-y-1/3"
            width="404"
            height="468"
        />
        ...
        <div class="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
            <div class="lg:col-span-1">
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Guidés par nos valeurs</h2>
            </div>
            <dl class="mt-10 space-y-10 sm:grid sm:grid-cols-2 sm:space-y-0 sm:gap-x-8 sm:gap-y-10 lg:col-span-2 lg:mt-0">
        ...
        <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-24">
                ...
                <div class="mt-12 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
                    <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-7">
                        <img class="max-h-14" src="{{ asset('media/logos/enac-logo.svg') }}" alt="ENAC" />
                    </div>

                    <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-7">
                        <img class="max-h-14" src="{{ asset('media/logos/snpl-logo.svg') }}" alt="SNPL" />
                    </div>

                    <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-7">
                        <img class="max-h-14" src="{{ asset('media/logos/air-france-logo.svg') }}" alt="Air France" />
                    </div>
                    ...
                    <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-7">
                        <img class="max-h-14" src="{{ asset('media/logos/appn-logo.png') }}" alt="Mirage" />
                    </div>

                    <div class="col-span-1 flex justify-center bg-gray-50 px-8 py-7">
                        <img class="max-h-14" src="{{ asset('media/logos/avico-logo-with-plane.svg') }}" alt="Avico" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- CTA section -->
    <div class="relative mt-24 overflow-hidden pb-8 sm:mt-32 sm:py-16">
        ...
        <a
            class="group mx-auto block max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8"
            href="{{ route('public.association.team') }}"
        >
            <div class="bg-dandelion-500 group-hover:bg-dandelion-400 relative overflow-hidden rounded-2xl px-6 py-10 shadow-xl sm:px-12 sm:py-20">
                ...
                <div class="relative">
                    ...
                    <div class="mt-12 justify-center -space-y-4 md:space-y-0 md:-space-x-3 lg:flex">
                        <div class="justify-center -space-y-4 sm:flex sm:space-y-0 sm:-space-x-3">
                            <div class="flex justify-center -space-x-3">
                                <div class="ring-dandelion-500 relative inline-block h-16 w-16 flex-none overflow-hidden rounded-full ring-4 md:h-20 md:w-20">
                                    <img
